...
export default function WerkzeugWorkspaceChrome({
  ...
  return (
    <>
      ...
      {panelKey && <div data-orientation={portrait ? "portrait" : "landscape"} data-hidden={panelHidden ? "true" : "false"} className="werkzeug-ipad-context pointer-events-auto fixed z-[68]" style={portrait ? { left: 8, right: 8, bottom: 56, height: collapsed ? 48 : drawerHeight } : { right: 0, top: 76, width: Math.min(330, window.innerWidth * .36), maxHeight: collapsed ? 48 : drawerHeight }}>
