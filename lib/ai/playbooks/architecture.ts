export const architectureGuide = {
  ...
  instructions: [
    ...
    "A shell is not a finished house. Use routine concept defaults for omitted footprint, storeys, rooms and roof; disclose assumptions and proceed. Prefer apartment_layout for basic apartments. Include circulation and partitions before describing a complete layout.",
