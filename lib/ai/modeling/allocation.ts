...
export type ResidentialParameters = { variant: ResidentialVariant; bedrooms: number; bedroomAreaM2?: number; totalAreaM2?: number; livingAreaM2?: number; kitchenAreaM2?: number; bathroomAreaM2?: number; apartmentFloors?: number; apartmentsPerFloor?: number; bedroomsPerApartment?: 1|2|3; layoutStyle?: "linear" | "courtyard" | "corner" | "split" | "central"; furnished?: boolean; underfloorHeating?: boolean; piping?: "none" | "underfloor" | "ceiling"; ducts?: "none" | "ceiling"; garage?: "none" | "open" | "enclosed"; garageWidthM?: number; garageDepthM?: number; gardenAreaM2?: number; footprint?: "rectangle" | "l" | "u" | "drawn"; widthM?: number; lengthM?: number; footprintPoints?: { x: number; y: number }[]; sketches?: FloorSketch[] };
export const RESIDENTIAL_PRESETS = [
  { label: "Multi-storey apartments", variant: "apartment", bedrooms: 2, apartmentFloors: 4, apartmentsPerFloor: 4, bedroomsPerApartment: 2, layoutStyle: "central" },
  { label: "1-bedroom starter apartment", variant: "apartment", bedrooms: 1, layoutStyle: "linear" },
  { label: "2-bedroom courtyard apartment", variant: "apartment", bedrooms: 2, layoutStyle: "courtyard" },
  { label: "3-bedroom corner apartment", variant: "apartment", bedrooms: 3, layoutStyle: "corner" },
  { label: "4-bedroom split apartment", variant: "apartment", bedrooms: 4, layoutStyle: "split" },
  { label: "Villa", variant: "villa", bedrooms: 3, layoutStyle: "linear" },
