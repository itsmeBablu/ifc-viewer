...
export const SHORTCUTS: ShortcutDefinition[] = [
  ...
  { id: "floor", combo: "Shift+F", label: "Floor", description: "Sketch a closed floor boundary, including holes.", category: "Draw Tools" },
  ...
  { id: "flex_duct", combo: "Shift+G", label: "Flex Duct", description: "Draw a flexible duct run.", category: "MEP Tools" },
